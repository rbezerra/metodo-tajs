...
Then(`I request the API with the user's ID "2"`, async function () {
...
Then(`the user should be categorized as an "Adult"`, async function () {
  assert.strictEqual(_context.createdUserData.category, "Adult");
});
...
Then(`the user's category should be "Adult"`, async function(){
  assert.strictEqual(_context.createdUserData.category, "Adult");
})
